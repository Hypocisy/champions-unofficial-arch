...
public final class ScriptableAffixType extends AffixType<EmptyAffixData> {
     ...
     * creates a {@link ScriptableAffixType} from it. Extends KubeJS's
     * {@link BuilderBase} so {@code StartupEvents.registry('champions:affix_type', ...)}
     * can instantiate it from scripts.
     */
    public static final class Builder extends BuilderBase<ScriptableAffixType> {
        ...
        public RegistryInfo<?> getRegistryType() {
            return ChampionsKubeJSPlugin.AFFIX_TYPE;
        }

        @Override
        public ScriptableAffixType createObject() {
            return build();
        }
